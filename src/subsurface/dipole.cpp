...
public:
	...
	void configure() {
		Log(EInfo, "m_sigmaS %f %f %f", m_sigmaS[0], m_sigmaS[1], m_sigmaS[2]);
		Log(EInfo, "m_sigmaA %f %f %f", m_sigmaA[0], m_sigmaA[1], m_sigmaA[2]);
		Log(EInfo, "m_g %f %f %f", m_g[0], m_g[1], m_g[2]);
