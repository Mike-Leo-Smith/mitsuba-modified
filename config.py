...
CXX            = 'g++'
CC             = 'gcc'
CXXFLAGS       = ['-std=c++11','-Ofast', '-Wall', '-pipe', '-ffast-math', '-flto', '-march=native', '-ftree-vectorize', '-funsafe-math-optimizations', '-fno-rounding-math', '-fno-signaling-nans', '-fno-math-errno', '-fomit-frame-pointer', '-DSINGLE_PRECISION', '-DSPECTRUM_SAMPLES=3', '-DMTS_SSE', '-DMTS_HAS_COHERENT_RT', '-fopenmp', '-fvisibility=hidden', '-mtls-dialect=gnu2']
LINKFLAGS      = []
